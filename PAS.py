...
TOKEN = '6968842687:AAHJ2Wtm7sgLk4IN6gHbgcVr-zX0rj1IS9Q'
BOT_USERNAME = 'venitabot'
...
async def start_command(update: Update, context):
    ...
    await update.message.reply_text('Hello! Thanks for chatting with me! I am an AxvoraBot!', reply_markup=reply_markup)
...
async def about_command(update: Update, context):
    await update.message.reply_text('About AxvoraBot:\nThis is a simple Telegram bot created by Axvora.')
...
async def minecraft_web_command(update: Update, context):
    await update.message.reply_text("https://www.minecraft.com")

async def webstore_command(update: Update, context):
    await update.message.reply_text("Welcome to our store!\nyou can open our store by this link!\nhttps://www.axvora.my.id/store")
...
if _name_ == '_main_':
    ...
    app.add_handler(CommandHandler('minecraft_web', minecraft_web_command))
